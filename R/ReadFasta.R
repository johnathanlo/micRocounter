...
ReadFasta <- function(file, minrepeats = c(6,4,3,3,3), squishy = c(0,0,0,0,0)){#minrepeats&squishy = vectors of values corresponding to two, three, four, five, and six-mers respectively
